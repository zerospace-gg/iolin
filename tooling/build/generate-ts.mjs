...
async function generateEntityFile(jsonFilePath, entity, outputPath) {
  ...
  const content = `// Auto-generated entity file
// This file is generated by generate-ts.mjs - do not edit manually
import type { ${tsType} } from "${relativePath}";
...
function generateCollectionFile(
  ...
  groupData.entries.forEach((entry) => {
    ...
    imports.push(`import ${importName} from "${relativePath}.js";`);
    entries.push({
      id: entry.id,
...
// Create and export the collection object
...
function generateIolinIndexFile(idxData, idxPath) {
  ...
  export const IolinIndex: MetaIdx = {
    all: All,
    ids: Ids,
  };
...
// Export both named and default for ES modules compatibility
export { ${exportName} };
export default ${exportName};
`;
...
function generateAllFile(typeGroups) {
  ...
  Object.entries(typeGroups).forEach(([typeKey, groupData]) => {
    ...
    imports.push(`import ${safeName} from "./${fileName}.js";`);
...
async function copyTypeDefinitions() {
  const sourceTypes = path.join(__dirname, "..", "iolin-npm", "gg-iolin.d.ts");
